...
const ContactMe = (props: Props) => {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {
    window.location.href = `mailto:ezechekwubeinnocent@gmail.com?subject=${formData.subject}&body=Hi Chekwube, my name is ${formData.name}. ${formData.message} (${formData.email})`;
  };
  return (
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center space-x-5 justify-center  ">
            ...
            <p className="font-semibold text-xl md:text-4xl">
              ezechekwubeinnocent@gmail.com
            </p>
          </div>
          <div className="flex items-center space-x-5 justify-center  ">
            <MapPinIcon className="h-7 w-7 animate-pulse text-[#995614]  " />
            <p className="font-semibold text-xl md:text-4xl">Jyväskylä, Finland</p>
          </div>
        </div>
